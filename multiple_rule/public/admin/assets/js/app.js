  ...
  n("#side-menu").metisMenu(),
    ...
    n("#mode-setting-btn").on("click", function (t) {
      r.hasAttribute("data-layout-mode") && "dark" == r.getAttribute("data-layout-mode")
        ? (document.body.setAttribute("data-layout-mode", "light"), document.body.setAttribute("data-topbar", "light"), document.body.setAttribute("data-sidebar", "light"), (r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout")) || document.body.setAttribute("data-sidebar", "light"), e("topbar-color-light"), e("sidebar-color-light"), e("topbar-color-light"))
        : (document.body.setAttribute("data-layout-mode", "dark"), document.body.setAttribute("data-topbar", "dark"), document.body.setAttribute("data-sidebar", "dark"), (r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout")) || document.body.setAttribute("data-sidebar", "dark"), e("layout-mode-dark"), e("sidebar-color-dark"), e("topbar-color-dark"));
    }),
    n(document).on("click", "body", function (t) {
      0 < n(t.target).closest(".right-bar-toggle, .right-bar").length || n("body").removeClass("right-bar-enabled");
    }),
    ...
    r.hasAttribute("data-sidebar-size") && "sm" == r.getAttribute("data-sidebar-size") ? e("sidebar-size-small") : r.hasAttribute("data-sidebar-size") && "md" == r.getAttribute("data-sidebar-size") ? e("sidebar-size-compact") : e("sidebar-size-default"),
    r.hasAttribute("data-sidebar") && "colored" == r.getAttribute("data-sidebar") ? e("sidebar-color-colored") : r.hasAttribute("data-sidebar") && "dark" == r.getAttribute("data-sidebar") ? e("sidebar-color-dark") : e("sidebar-color-light"),
    ...
    n("input[name='layout-mode']").on("change", function () {
      "light" == n(this).val()
        ? (document.body.setAttribute("data-layout-mode", "light"), document.body.setAttribute("data-topbar", "light"), document.body.setAttribute("data-sidebar", "light"), (r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout")) || document.body.setAttribute("data-sidebar", "light"), e("topbar-color-light"), e("sidebar-color-light"))
        : (document.body.setAttribute("data-layout-mode", "dark"), document.body.setAttribute("data-topbar", "dark"), document.body.setAttribute("data-sidebar", "dark"), (r.hasAttribute("data-layout") && "horizontal" == r.getAttribute("data-layout")) || document.body.setAttribute("data-sidebar", "dark"), e("topbar-color-dark"), e("sidebar-color-dark"));
    }),
    n("input[name='layout-direction']").on("change", function () {
      "ltr" == n(this).val()
        ? (document.getElementsByTagName("html")[0].removeAttribute("dir"), document.getElementById("bootstrap-style").setAttribute("href", "assets/css/bootstrap.min.css"), document.getElementById("app-style").setAttribute("href", "assets/css/app.min.css"))
        : (document.getElementById("bootstrap-style").setAttribute("href", "assets/css/bootstrap-rtl.min.css"), document.getElementById("app-style").setAttribute("href", "assets/css/app-rtl.min.css"), document.getElementsByTagName("html")[0].setAttribute("dir", "rtl"));
    }),
    Waves.init();
})(jQuery);
